...
namespace UI.Web.API.Controllers
{
    ...
    [ApiController]
    public abstract class SaadApiController : ControllerBase
    {
        protected readonly ILogger<SaadApiController> _logger;

        protected SaadApiController(ILogger<SaadApiController> logger)
        {
            _logger = logger;
        }
